...
<form class="form-inline my-2 my-lg-0 mr-lg-2" id="formSearch">
	<input type="hidden" id="optParam" value=""/>
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-primary o-hidden h-100">
			<div class="card-body">
				...
				<div class="mr-5">오늘 가입자수<br/>▶ ${uStt.todayCnt }</div>
			</div>
			<a class="card-footer text-white clearfix small z-1" href="/admin/user/user"> <span
				class="float-left">더보기</span> <span class="float-right">
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-warning o-hidden h-100">
			<div class="card-body">
				...
				<div class="mr-5">☞ ${uStt.totalCnt }<br/>총 가입자수</div>
			</div>
			<a class="card-footer text-white clearfix small z-1" href="/admin/user/user"> <span
				class="float-left">더보기</span> <span class="float-right">
					<i class="fa fa-angle-right"></i>
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-success o-hidden h-100">
			<div class="card-body">
				...
				<div class="mr-5">☞  ${pStt.todayCnt }<br/>오늘 포스팅수</div>
			</div>
			<a class="card-footer text-white clearfix small z-1" href="/admin/posting/post"> <span
				class="float-left">더보기</span> <span class="float-right">
					<i class="fa fa-angle-right"></i>
			</span>
			</a>
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-danger o-hidden h-100">
			<div class="card-body">
				...
				<div class="mr-5">☞  ${pStt.totalCnt }<br/>총 포스팅수</div>
			</div>
			<a class="card-footer text-white clearfix small z-1" href="/admin/posting/post"> <span
				class="float-left">더보기</span> <span class="float-right">
					<i class="fa fa-angle-right"></i>
...
<div class="card mb-2">
	<div class="card-header">
		<i class="fa fa-table"></i> 최근 접속 정보
	</div>
	<div class="card-body" >
					...
					<td width="50%" align="center" valign="top">
						<table class="table table-bordered" width="90%" cellspacing="0">
							...
							<c:forEach items="${ulist }" var="uvo" varStatus="status">
								<tr>
									<td name='uNickname'>${uvo.nickname}</td>
									<td name='uContents'>${uvo.email}</td>
									<td>${uvo.role}</td>
									<td>${uvo.joindate}</td>
								</tr>
							</c:forEach>
					...
					<td width="50%" align="center" valign="top">
						<table class="table table-bordered" width="90%" cellspacing="0">
							...
							<c:forEach items="${plist }" var="pvo" varStatus="status">
								<tr>
									<td name="pContents">${pvo.content}</td>
									<td>${pvo.nickname}</td>
									<td>${pvo.postDate }</td>
								</tr>
							</c:forEach>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var rowLen = $("td[name='pContents']").length;
		var uTdNnm = $("td[name='uNickname']");
		var uTdCtt = $("td[name='uContents']");
		var pTdCtt = $("td[name='pContents']");
		
		for(var i=0; i<rowLen; i++)
		{
			uTdNnm.eq(i).text( cutByte(uTdNnm.eq(i).text(), 12) );
			uTdCtt.eq(i).text( cutByte(uTdCtt.eq(i).text(), 20) );
			pTdCtt.eq(i).text( cutByte(pTdCtt.eq(i).text(), 25) );
		}
